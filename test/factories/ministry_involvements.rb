Factory.define :ministryinvolvement_1, :class => MinistryInvolvement do |m|
   m.id '1'
   m.person_id '50000'
   m.ministry_id '1'
...
Factory.define :ministryinvolvement_2, :class => MinistryInvolvement do |m|
   m.id '2'
   m.person_id '50000'
   m.ministry_id '2'
   m.ministry_role_id '1'
...
Factory.define :ministryinvolvement_3, :class => MinistryInvolvement do |m|
   m.id '3'
   m.person_id '3000'
   m.ministry_id '2'
...
Factory.define :ministryinvolvement_4, :class => MinistryInvolvement do |m|
   m.id '4'
   m.person_id '2000'
   m.ministry_id '1'
