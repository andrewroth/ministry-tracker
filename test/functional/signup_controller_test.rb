...
class SignupControllerTest < ActionController::TestCase
  ...
  test "step1_info_submit" do
    ...
    assert_equal 1, assigns(:person).gender
    ...
    assert_same assigns(:user).id, assigns(:person).user.id
  ...
  test "step2_default_group" do
    ...
    assert_equal "University of California-Davis interested in a Bible Study", assigns(:group).name
