...
) ENGINE=InnoDB AUTO_INCREMENT=190918 DEFAULT CHARSET=utf8;
...
CREATE TABLE `global_profiles` (
  ...
  `updated_at` datetime DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=125699 DEFAULT CHARSET=latin1;
...
) ENGINE=InnoDB AUTO_INCREMENT=10807 DEFAULT CHARSET=utf8;
...
) ENGINE=InnoDB AUTO_INCREMENT=12340 DEFAULT CHARSET=utf8;
...
) ENGINE=InnoDB AUTO_INCREMENT=304224 DEFAULT CHARSET=utf8;
...
INSERT INTO schema_migrations (version) VALUES ('20110308205916');
...
INSERT INTO schema_migrations (version) VALUES ('20110325193551');
