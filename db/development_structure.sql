...
CREATE TABLE `event_attendees` (
  ...
  `updated_at` datetime DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `index_c4c_pulse_prod.event_attendees_on_event_id` (`event_id`),
  KEY `index_c4c_pulse_prod.event_attendees_on_ticket_id` (`ticket_id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
) ENGINE=InnoDB AUTO_INCREMENT=193272 DEFAULT CHARSET=utf8;
...
CREATE TABLE `group_invitations` (
  ...
  `updated_at` datetime DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `index_c4c_pulse_prod.group_invitations_on_group_id` (`group_id`),
  KEY `index_c4c_pulse_prod.group_invitations_on_login_code_id` (`login_code_id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `login_codes` (
  ...
  `updated_at` datetime DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `index_c4c_pulse_prod.login_codes_on_code` (`code`)
...
) ENGINE=InnoDB AUTO_INCREMENT=10569 DEFAULT CHARSET=utf8;
...
CREATE TABLE `person_event_attendees` (
  ...
  `updated_at` datetime DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `index_c4c_pulse_prod.person_event_attendees_on_person_id` (`person_id`),
  KEY `index_c4c_pulse_prod.person_event_attendees_on_event_attendee_id` (`event_attendee_id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `searches` (
  ...
  `updated_at` datetime DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=9859 DEFAULT CHARSET=utf8;
...
) ENGINE=InnoDB AUTO_INCREMENT=395858 DEFAULT CHARSET=utf8;
...
CREATE TABLE `user_codes` (
  ...
  KEY `index_c4c_pulse_prod.user_codes_on_login_code_id` (`login_code_id`)
