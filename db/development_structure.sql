...
) ENGINE=InnoDB AUTO_INCREMENT=130685 DEFAULT CHARSET=utf8;
...
) ENGINE=InnoDB AUTO_INCREMENT=6490 DEFAULT CHARSET=utf8;
...
CREATE TABLE `searches` (
  ...
  `updated_at` datetime DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=7839 DEFAULT CHARSET=utf8;
...
) ENGINE=InnoDB AUTO_INCREMENT=110257 DEFAULT CHARSET=utf8;
