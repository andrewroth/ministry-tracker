...
) ENGINE=InnoDB AUTO_INCREMENT=90491 DEFAULT CHARSET=utf8;
...
CREATE TABLE `searches` (
  ...
  `updated_at` datetime DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=5696 DEFAULT CHARSET=utf8;
...
) ENGINE=InnoDB AUTO_INCREMENT=76685 DEFAULT CHARSET=utf8;
