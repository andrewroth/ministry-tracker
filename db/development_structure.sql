...
CREATE TABLE `global_dashboard_whq_stats` (
  ...
  `updated_at` datetime DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=16334 DEFAULT CHARSET=utf8;
...
CREATE TABLE `global_profiles` (
  ...
  `updated_at` datetime DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=36338 DEFAULT CHARSET=utf8;
...
) ENGINE=InnoDB AUTO_INCREMENT=7436 DEFAULT CHARSET=utf8;
...
) ENGINE=InnoDB AUTO_INCREMENT=305814 DEFAULT CHARSET=utf8;
