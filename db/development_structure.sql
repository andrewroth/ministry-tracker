...
) ENGINE=InnoDB AUTO_INCREMENT=193721 DEFAULT CHARSET=utf8;
...
CREATE TABLE `global_dashboard_whq_stats` (
  ...
  `updated_at` datetime DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=16464 DEFAULT CHARSET=utf8;
...
) ENGINE=InnoDB AUTO_INCREMENT=11083 DEFAULT CHARSET=utf8;
...
) ENGINE=InnoDB AUTO_INCREMENT=7548 DEFAULT CHARSET=utf8;
...
) ENGINE=InnoDB AUTO_INCREMENT=12803 DEFAULT CHARSET=utf8;
...
) ENGINE=InnoDB AUTO_INCREMENT=423824 DEFAULT CHARSET=utf8;
