...
CREATE TABLE `group_invitations` (
  ...
  `updated_at` datetime DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `index_c4c_pulse_staging.group_invitations_on_group_id` (`group_id`),
  KEY `index_c4c_pulse_staging.group_invitations_on_login_code_id` (`login_code_id`)
...
CREATE TABLE `login_codes` (
  ...
  `updated_at` datetime DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `index_c4c_pulse_staging.login_codes_on_code` (`code`)
...
) ENGINE=InnoDB AUTO_INCREMENT=395561 DEFAULT CHARSET=utf8;
...
CREATE TABLE `user_codes` (
  ...
  KEY `index_c4c_pulse_staging.user_codes_on_login_code_id` (`login_code_id`)
