...
ActiveRecord::Schema.define(:version => 20090115210516) do
  ...
  add_index "campus_involvements", ["campus_id"], :name => "campus_id"
  add_index "campus_involvements", ["ministry_id"], :name => "ministry_id"
  ...
  add_index "campuses", ["country"], :name => "country"
  add_index "campuses", ["county"], :name => "index_campuses_on_county"
  add_index "campuses", ["state"], :name => "state"

  create_table "columns", :force => true do |t|
    t.string   "title"
    t.string   "update_clause", :limit => 2000
    t.string   "from_clause",   :limit => 2000
    t.string   "select_clause", :limit => 2000
    t.string   "column_type",   :limit => 2000
    t.string   "writeable"
    t.datetime "created_at"
    t.datetime "updated_at"
    t.string   "join_clause",   :limit => 2000
  end
  ...
  add_index "ministry_campuses", ["ministry_id", "campus_id"], :name => "ministry_campus", :unique => true
  ...
  create_table "stint_locations", :force => true do |t|
    ...
    t.string   "studentCostExplaination"
