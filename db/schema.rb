...
ActiveRecord::Schema.define(:version => 20081104222308) do
  ...
  add_index "user_group_permissions", ["permission_id", "user_group_id"], :name => "index_user_group_permissions_on_permission_id_and_user_group_id", :unique => true
  ...
  add_index "user_memberships", ["user_id", "user_group_id"], :name => "index_user_memberships_on_user_id_and_user_group_id", :unique => true
