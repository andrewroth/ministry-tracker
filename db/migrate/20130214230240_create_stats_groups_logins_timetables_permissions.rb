class CreateStatsGroupsLoginsTimetablesPermissions < ActiveRecord::Migration
	NEW_PERMISSIONS = [{ :description => "Show Groups report", :controller => "stats", :action => "groups" },
	                   { :description => "Show Logins report", :controller => "stats", :action => "logins" },
	                   { :description => "Show Timetables report", :controller => "stats", :action => "timetables" }
	                   ]
