class AddPermissionToSearchWeb < ActiveRecord::Migration
  NEW_PERMISSIONS = [{ :description => "Return web results in search results", :controller => "search", :action => "web" }]

  NEW_MINISTRY_ROLE_PERMISSIONS = [{ :ministry_role_name => "Team Leader",  :permission_controller => "search", :permission_action => "web" },
                                   { :ministry_role_name => "Team Member",  :permission_controller => "search", :permission_action => "web" },
                                   { :ministry_role_name => "Staff",  :permission_controller => "search", :permission_action => "web" },
                                   { :ministry_role_name => "Student Leader",  :permission_controller => "search", :permission_action => "web" },
                                   { :ministry_role_name => "Ministry Leader",  :permission_controller => "search", :permission_action => "web" }]
