class AddProfileLabelAddPermissionFix < ActiveRecord::Migration
  NEW_PERMISSIONS = [{ :description => "Add person profile label", :controller => "people", :action => "add_profile_label" }]                     

  NEW_MINISTRY_ROLE_PERMISSIONS = [{ :ministry_role_name => "Team Leader",  :permission_controller => "people", :permission_action => "add_profile_label" },                                                
