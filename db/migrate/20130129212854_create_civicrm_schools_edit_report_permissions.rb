class CreateCivicrmSchoolsEditReportPermissions < ActiveRecord::Migration
    NEW_PERMISSIONS = [{ :description => "CiviCRM Schools edit", :controller => "civicrm_schools", :action => "edit" },
                       { :description => "CiviCRM Schools update", :controller => "civicrm_schools", :action => "update" }
                       ]
