class AddViewMenteeSummary < ActiveRecord::Migration
  NEW_PERMISSIONS = [{ :description => "Show mentee summary", :controller => "people", :action => "show_mentee_summary" }]                     

  NEW_MINISTRY_ROLE_PERMISSIONS = [{ :ministry_role_name => "Team Leader",  :permission_controller => "people", :permission_action => "show_mentee_summary" },                                                
                                   { :ministry_role_name => "Team Member",  :permission_controller => "people", :permission_action => "show_mentee_summary" },                                   
                                   { :ministry_role_name => "Ministry Leader",  :permission_controller => "people", :permission_action => "show_mentee_summary" },
                                   { :ministry_role_name => "Student Leader",  :permission_controller => "people", :permission_action => "show_mentee_summary" }]
