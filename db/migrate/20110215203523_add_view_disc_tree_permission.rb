class AddViewDiscTreePermission < ActiveRecord::Migration
  NEW_PERMISSIONS = [{ :description => "View discipleship tree", :controller => "people", :action => "discipleship" }]                     

  NEW_MINISTRY_ROLE_PERMISSIONS = [{ :ministry_role_name => "Team Leader",  :permission_controller => "people", :permission_action => "discipleship" },                                                
                                   { :ministry_role_name => "Team Member",  :permission_controller => "people", :permission_action => "discipleship" },                                   
                                   { :ministry_role_name => "Ministry Leader",  :permission_controller => "people", :permission_action => "discipleship" },
                                   { :ministry_role_name => "Student Leader",  :permission_controller => "people", :permission_action => "discipleship" }]
