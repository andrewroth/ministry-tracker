class CreateDiscoverReportPermissions < ActiveRecord::Migration
  NEW_PERMISSIONS = [{ :description => "Discover contact volunteer activity", :controller => "stats", :action => "discover_contact_volunteer_activity" },
                     { :description => "Discover contact thresholds summary", :controller => "stats", :action => "discover_contact_thresholds_summary" },
                     { :description => "Discover contacts summary", :controller => "stats", :action => "discover_contacts_summary" }
                     ]
