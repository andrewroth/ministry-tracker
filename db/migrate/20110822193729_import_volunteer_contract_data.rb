  ...
  NEW_CONTRACTS  = [
                    {:title => "Statement of Faith", :agreement_clause => "Without mental reservation, I hereby subscribe to the above statements and pledge myself to help fulfil the Great Commission in our generation, depending upon the Holy Spirit to guide and empower me.",
                     :clauses => [{:order => 1, :heading => "", :text => "The sole basis of our beliefs is the Bible, God's inerrant written Word, the 66 books of the Old and New Testaments.  We believe that it was uniquely, verbally and fully inspired by the Holy Spirit, and that it was written without factual error in the original manuscripts.  It is the supreme and final authority in all matters on which it speaks.", :checkbox => false},
                                  ...
                                  {:order => 3, :heading => "", :text => "1.	There is one true God, eternally existing in three persons—the Father, Son and Holy Spirit—each of whom possesses equally all the attributes of Deity and the characteristics of personality.", :checkbox => false},
                                  {:order => 4, :heading => "", :text => "2.	Jesus Christ is God, the living Word, who became flesh through His miraculous conception by the Holy Spirit and His virgin birth.  Hence, He is perfect Deity and true humanity united in one person forever.", :checkbox => false},
                                  {:order => 5, :heading => "", :text => "3.	He lived a sinless life and voluntarily atoned for our sins by dying on the cross as our substitute, thus satisfying divine justice and accomplishing salvation for all who trust in Him alone.", :checkbox => false},
                                  {:order => 6, :heading => "", :text => "4.	He rose from the dead in the same body, though glorified, in which He had lived and died.", :checkbox => false},
                                  {:order => 7, :heading => "", :text => "5.	He ascended bodily into heaven and sat down at the right hand of God the Father, where He, the only mediator between God and mankind, continually makes intercession for His own.", :checkbox => false},
                                  {:order => 8, :heading => "", :text => "6.	We were originally created in the image of God.  We sinned by disobeying God; thus, we were alienated from our Creator.  That historic fall brought all mankind under divine condemnation.", :checkbox => false},
                                  {:order => 9, :heading => "", :text => "7.	Our nature is corrupted, and we are thus totally unable to please God.  Every person is in need of regeneration and renewal by the Holy Spirit.", :checkbox => false},
                                  ...
                                  {:order => 11, :heading => "", :text => "9.	It is the privilege of all who are born again of the Spirit to be assured of their salvation from the very moment in which they trust Christ as their Saviour.  This assurance is not based upon any kind of human merit, but is produced by the witness of the Holy Spirit, who confirms in the believer the testimony of God in His written Word.", :checkbox => false},
                                  {:order => 12, :heading => "", :text => "10.	The Holy Spirit has come into the world to reveal and glorify Christ and to apply the saving work of Christ to men and women.  He convicts and draws sinners to Christ, imparts new life to them, continually indwells them from the moment of spiritual birth and seals them until the day of redemption.  His fullness, power and control are appropriated in the believer's life by faith.", :checkbox => false},
                                  {:order => 13, :heading => "", :text => "11.	We, as believers, are called to live in the power of the indwelling Spirit so that we will not fulfill the lust of the flesh but will bear fruit to the glory of God.", :checkbox => false},
                                  {:order => 14, :heading => "", :text => "12.	Jesus Christ is the Head of the Church, His Body, which is composed of all men and women, living and dead, who have been joined to Him through saving faith.", :checkbox => false},
                                  {:order => 15, :heading => "", :text => "13.	God admonishes His people to assemble together regularly for worship, for participation in ordinances, for edification through the Scriptures and for mutual encouragement.", :checkbox => false},
                                  {:order => 16, :heading => "", :text => "14.	At physical death the believers enter immediately into eternal conscious fellowship with the Lord, and await the resurrection of their bodies to everlasting glory and blessing.", :checkbox => false},
                                  {:order => 17, :heading => "", :text => "15.	At physical death the unbelievers enter immediately into eternal conscious separation from the Lord and await the resurrection of their bodies to everlasting judgment and condemnation.", :checkbox => false},
                                  {:order => 18, :heading => "", :text => "16. 	Jesus Christ will come again to the earth—personally, visibly and bodily—to consummate history and the eternal plan of God.", :checkbox => false},
