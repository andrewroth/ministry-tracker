class FillPreviousLnzValues < ActiveRecord::Migration
  SEMESTER_LNZ_COLUMNS = {:semesterreport_lnz_avgPrayer => :monthlyreport_avgPrayer, 
                          :semesterreport_lnz_numFrosh => :monthlyreport_numFrosh, 
                          :semesterreport_lnz_totalStudentInDG => :monthlyreport_totalStudentInDG, 
                          :semesterreport_lnz_totalSpMult => :monthlyreport_totalSpMult, 
                          :semesterreport_lnz_totalCoreStudents => :monthlyreport_totalCoreStudents}
  
  ANNUAL_LNZ_COLUMNS = {:annualReport_lnz_avgPrayer => :monthlyreport_avgPrayer, 
                        :annualReport_lnz_numFrosh => :monthlyreport_numFrosh, 
                        :annualReport_lnz_totalStudentInDG => :monthlyreport_totalStudentInDG, 
                        :annualReport_lnz_totalSpMult => :monthlyreport_totalSpMult, 
                        :annualReport_lnz_totalCoreStudents => :monthlyreport_totalCoreStudents}
