class AddPermissionToViewMentorProfile < ActiveRecord::Migration

  NEW_PERMISSIONS = [{ :description => "Show mentor profile via hot-link", :controller => "people", :action => "view_mentor_profile" }]                     

  NEW_MINISTRY_ROLE_PERMISSIONS = [{ :ministry_role_name => "Team Leader",  :permission_controller => "people", :permission_action => "view_mentor_profile" },                                                
                                   { :ministry_role_name => "Team Member",  :permission_controller => "people", :permission_action => "view_mentor_profile" },                                   
                                   { :ministry_role_name => "Ministry Leader",  :permission_controller => "people", :permission_action => "view_mentor_profile" }]
