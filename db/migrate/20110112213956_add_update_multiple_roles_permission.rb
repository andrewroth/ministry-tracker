class AddUpdateMultipleRolesPermission < ActiveRecord::Migration
  NEW_PERMISSIONS = [{ :description => "Update Multiple Ministry Roles", :controller => "ministry_involvements", :action => "update_multiple_roles" }]
