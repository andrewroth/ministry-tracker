class AddContractPermissionsToInternationalStaff < ActiveRecord::Migration
  ...
  NEW_MINISTRY_ROLE_PERMISSIONS = [{ :ministry_role_name => "International Staff",  :permission_controller => "contract", :permission_action => "volunteer_agreement" },
                                   
                                   { :ministry_role_name => "International Staff",  :permission_controller => "contract", :permission_action => "sign_volunteer_contract" },
                                   
                                   { :ministry_role_name => "International Staff",  :permission_controller => "contract", :permission_action => "volunteer_agreement_not_required" },
                                   
                                   { :ministry_role_name => "International Staff",  :permission_controller => "contract", :permission_action => "decline_volunteer_contract" }
                                   ]
