class AddShowTotalIndicatedDecisionsPermission < ActiveRecord::Migration
  NEW_PERMISSIONS = [{ :description => "Show Total Indicated Decisions", :controller => "stats", :action => "show_total_indicated_decisions" }]
