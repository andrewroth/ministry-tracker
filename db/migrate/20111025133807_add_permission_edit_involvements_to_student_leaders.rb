class AddPermissionEditInvolvementsToStudentLeaders < ActiveRecord::Migration

  NEW_MINISTRY_ROLE_PERMISSIONS = [
                                    { :ministry_role_name => "Student Leader",  :permission_controller => "campus_involvements", :permission_action => "edit" },
                                    { :ministry_role_name => "Student Leader",  :permission_controller => "campus_involvements", :permission_action => "index" }
                                  ]
