class AddMoreStatsPermissions < ActiveRecord::Migration

  NEW_PERMISSIONS = [{ :description => "Submit Semester Stats", :controller => "prcs", :action => "new" }]

  NEW_MINISTRY_ROLE_PERMISSIONS = [{ :ministry_role_id => 1,  :controller => "prcs", :action => "new" },
                                   { :ministry_role_id => 13, :controller => "prcs", :action => "new" }]
